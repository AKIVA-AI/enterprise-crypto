...
export const STRATEGY_TEMPLATES: StrategyTemplate[] = [
  ...
  // ============ PROFESSIONAL TIER ============
  {
    id: 'basic-market-making',
    name: 'Basic Market Making',
    description: 'Captures bid-ask spread by placing limit orders on both sides. Manages inventory risk with dynamic quote adjustments. Best for liquid pairs with tight spreads.',
    ...
    defaultConfig: {
      ...
      parameters: {
        ...
        max_inventory_pct: 15,
        order_size_pct: 0.5,
        refresh_interval_ms: 1000,
        cancel_on_fill: true,
        hedge_threshold_pct: 10,
        min_edge_bps: 2,
    ...
    riskProfile: 'Consistent small gains, inventory risk',
    capitalRequirement: '$25,000+',
    researchBasis: 'Simplified Avellaneda-Stoikov model',
  },
  {
    id: 'order-flow-momentum',
    name: 'Order Flow Momentum',
    description: 'Analyzes trade tape imbalances to detect aggressive buying/selling. Enters in direction of dominant flow with tight stops. Uses volume-weighted signals.',
    category: 'momentum',
    tier: 'professional',
    icon: <Activity className="h-5 w-5" />,
    defaultConfig: {
      ...
      parameters: {
        ...
        vwap_filter: true,
        aggressive_trade_weight: 2.0,
        passive_trade_weight: 1.0,
    ...
    difficulty: 'advanced',
    expectedReturn: '25-50% annually',
    riskProfile: 'High frequency, requires low latency',
    capitalRequirement: '$10,000+',
    researchBasis: 'Kyle (1985) market microstructure, order flow toxicity',
  },
  {
